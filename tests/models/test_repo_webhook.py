...
class RepositoryWebhookTest(ModelTest):
    def create_model(self, data: Mapping[str, Any]) -> ModelObject:
        return RepositoryWebhook.from_model_data(data)

    @property
    def template_function(self) -> str:
        return JsonnetConfig.create_repo_webhook
    ...
    async def test_changes_to_provider(self):
        ...
        provider_data = await RepositoryWebhook.changes_to_provider(self.org_id, changes, self.provider)
