...
class RepositoryDependabotSecret(Secret):
    """
    Represents a Dependabot Secret defined on repo level.
    """
    ...
    async def apply_live_patch(
        cls,
        patch: LivePatch[RepositoryDependabotSecret],
        org_id: str,
        ...
        match patch.patch_type:
            ...
            case LivePatchType.REMOVE:
                await provider.delete_repo_dependabot_secret(
                    org_id,
                    repository.name,
