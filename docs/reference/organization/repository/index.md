...
| _gh_pages_visibility_                     | string or null                                            | The visibility of the GitHub Pages site                                                  | `public` or `private`. Only available for private repositories in enterprise organizations with `members_can_create_private_pages` enabled                                    |
