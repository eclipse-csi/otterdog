...
| _required_status_checks_           | [StatusCheckSettings](#status-check-settings) | If enabled, status checks must pass before branches can be merged into a matching branch                                                                                                   |                                                                                                                                 |
...
| _required_pull_request_            | [PullRequestSettings](#pull-request-settings) | If specified, requires a pull request before merging. All commits must be made to a non-protected branch and submitted via a pull request before they can be merged into matching branches |                                                                                                                                 |
